...
class DashboardPage(tk.Frame):
    ...
    def _build(self, root):
        ...
        self._card_stretch = MetricCard(cards_row, "스트레칭 완료",  "--",
                                         f"오늘 목표  {STRETCH_GOAL}회", TEXT_PRI)
    ...
    def refresh(self):
        ...
        if summary:
            ...
            self._card_time.update(fmt_duration_ko(summary["good_posture_sec"]),
                                    "바른 자세 유지", CLR_GOOD)
    ...
    def _draw_chart(self):
        ...
        for i, hour in enumerate(hours):
            ...
            if score is not None:
                ...
                if score >= 80:   col = "#2ECC9A"
                elif score >= 60: col = "#63B3ED"
                elif score >= 40: col = "#F6AD55"
                else:             col = "#FC8181"
            else:
                bh, y_top, col = 4, pad_t + chart_h - 4, "#E2E8F0"
